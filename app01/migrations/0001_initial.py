    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('articles', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app01.Article', verbose_name='评论文章')),
                ('parent_comment_id', models.ForeignKey(null='True', on_delete=django.db.models.deletion.CASCADE, to='app01.Comment')),
                ('userinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='评论者')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
